...
{
    class Battleship_Field_Validation
    {
        ...
        internal int GetTotalNumberOfOnes()
        {
            int cellsOccupied = 0;
        ...
        internal int GetTotalShipsAccordingToSize(int shipSize)
        {
        ...
        internal bool CheckForSubmarines(int row, int col)//Submarines will only occupy one cell.
        {
            bool submarine = true;
            bool xAxis = true;
            bool yAxis = false;
